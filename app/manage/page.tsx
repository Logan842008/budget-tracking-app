        ...
        <div className="container flex flex-wrap items-center justify-between gap-6 py-8">
          <div>
            ...
            <p className="text-muted-foreground">
              Manage your account seetings and categories
            </p>
          </div>
        </div>
      </div>
...
function CategoryCard({ category }: { category: Category }) {
  return (
    <div className="flex border-seperate flex-col justify-between rounded-md border shadow-md shadow-black/[0.1]">
      ...
      <DeleteCategoryDialog
        ...
        trigger={
          <Button
            className="flex w-full border-separate items-center gap-2 rounded-t-none text-muted-foreground hover:bg-red-500/50"
            variant={"secondary"}
          >
