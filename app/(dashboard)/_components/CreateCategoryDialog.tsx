    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        {trigger ? (
          ...
          <Button
            variant={"ghost"}
            className="flex broder-seperate items-center justify-start rounded-none border-b px-3 py-3 text-muted-foreground"
          >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    This is how your category will appear on the app
                  </FormDescription>
                </FormItem>
              )}
            />
