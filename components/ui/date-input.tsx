  ...
  return (
    <div className="flex border rounded-lg items-center text-sm px-1">
      <input
        ...
        className="p-0 bg-transparent outline-none w-6 border-none text-center"
        placeholder="M"
      />
      ...
      <input
        ...
        className="p-0 bg-transparent outline-none w-7 border-none text-center"
        placeholder="D"
      />
      <span className="opacity-20 -mx-px">/</span>
      <input
        ...
        className="p-0 bg-transparent outline-none w-12 border-none text-center"
        placeholder="YYYY"
      />
    </div>
  );
